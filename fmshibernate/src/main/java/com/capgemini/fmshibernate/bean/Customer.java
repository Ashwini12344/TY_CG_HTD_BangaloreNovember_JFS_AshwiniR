...
public class Customer {
	...
	public String toString() {
		return "Customer [customerid=" + customerid + ", customer_name=" + customer_name + ", street_address1="
				+ street_address1 + ", street_address2=" + street_address2 + ", town=" + town + ", postal_code="
				+ postal_code + ", email=" + email + ", telephone=" + telephone + "]";
	}
